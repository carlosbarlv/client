...
const AccountWithdrawalModal = ({
  ...
  return (
    <CustomModal
      title={<CustomTitle level={4}>
        {isPayment? 'Ordenes de pago': 'Retiro Cuentas de Ahorros'  }
      </CustomTitle>}
      visible={visible}
      width={width}
      onOk={onOkClick}
    ...
    >
      <CustomForm {...labelColFullWidth}>
        <CustomRow gutter={[24, 0]} align={'top'}>
          <CustomCol span={17}>
              ...
              isPayment && 
                <CustomRow>
                  <CustomCol xs={12}>
                    ...
                    >
                      <CustomInputNumber placeholder={'00001'} />
                    </CustomFormItem>
                  </CustomCol>
                  <CustomCol xs={12}>
                  ...
                  <CustomCol span={24}>
                    <CustomFormItem label={'Beneficiario'}>
                      <CustomInput placeholder={'Francisco Yusepiz Rosario'} />
                    </CustomFormItem>
                  </CustomCol>
                </CustomRow>
            }
          ...
          <CustomCol span={7}>
            <CustomCol span={24}>
              <CustomTitle level={4}>Firmas Autorizadas</CustomTitle>
